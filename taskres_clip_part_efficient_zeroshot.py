...
def main():
    ...
    model_name = 'taskres'
    cache_dir = os.path.join('./mycaches_id', cfg['id_dataset'], model_file_name_dict[cfg['backbone']], str(cfg['shots'])+'shots',model_name+'_zeroshot','lenx'+str(multiply_factor),'lr0002'  )  #  new_test   seed1

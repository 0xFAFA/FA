...
def main():
    ...
    model_name = 'coop'
    cache_dir = os.path.join('./mycaches_id', cfg['id_dataset'], model_file_name_dict[cfg['backbone']], str(cfg['shots'])+'shots',model_name+'_efficient_batchs160_ep50','lenx'+str(multiply_factor_name),'lr0002'  )  #  new_test   seed1   
    ...
    if is_train == 1:
        ...
        sys.stdout = Logger( os.path.join(cache_dir,f'log_test_ood_GL_justoriginlenacc.txt') ,  stream=sys.stdout)
        print("\nRunning configs.")
        print(cfg, "\n")
        ...
        if cfg['id_dataset'] in ['imagenet', 'fgvc', 'caltech101', 'stanford_cars', 'food101']  :

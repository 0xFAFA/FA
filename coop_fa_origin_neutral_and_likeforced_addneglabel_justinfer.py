...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, 
        ...
        print(f"self.text_features_origin_label.shape: {self.text_features_origin_label.shape}")
    ...
    def forward(self, image):
        ...
        text_features_label = self.text_features_origin_label / self.text_features_origin_label.norm(dim=-1, keepdim=True) 
        ...
        logits_neglabel = logit_scale * image_features @ text_features_label.transpose(-1, -2)
        logits_local_neglabel = logit_scale * local_image_features @ text_features_label.T
...
def main():
    ...
    # neg_label_txt = "./selected_neg_labels.txt"
    neg_label_list = []
    ...
    neg_label_list = neg_label_list[:(cfg['origin_neglabel_len'] * 1000)]
    ...
    if is_train == 1:
        ...
        if cfg['ood_dataset'] == 'challenging':
            ...
            test_file_name = f"log_test_ood_common_addneglabel_newscore_{cfg['origin_neglabel_len']}.txt"
        else:

...
class AttentionPool2d(nn.Module):
    def __init__(self, spacial_dim: int, embed_dim: int, num_heads: int, output_dim: int = None):
        ...
        # print('$$$$$$$$$=====')
        # print(embed_dim, output_dim) # 2048  1024
...
class ModifiedResNet(nn.Module):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64):
        ...
        # print('embed_dim', embed_dim) # 2048
        print('output_dim', output_dim) #  1024
    ...
    def forward(self, x):
        ...
        # print('x_global', x_global.shape) #x_global torch.Size([B, 1024])
        # print('x_local', x_local.shape) #x_local torch.Size([B, 49, 1024])
...
class VisionTransformer(nn.Module):
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int, output_dim: int):
        ...
        # print('proj', width, output_dim)  #768  512
    ...
    def forward(self, x: torch.Tensor):
        ...
        k = k[:, 1:]
        v = v[:, 1:]
        # print(q.shape, k.shape, v.shape)  # torch.Size([B, 196, 768]) 
        ...
        if self.proj is not None:
            x = x @ self.proj
            feat = v @ self.proj #
        # print(x.shape, feat.shape)  # torch.Size([B, 512]) torch.Size([B, 196, 512])
        return x, feat
...
class CLIP(nn.Module):
    def __init__(self,
        ...
        # print('===========')
        # print(transformer_width, embed_dim) # VITB16:512 512 ,RN50:512 1024

...
def main():
    ...
    if is_train == 1:
        ...
        if cfg['ood_dataset'] == 'challenging':
            test_file_name = 'log_test_ood_challenging_sumversion.txt'
        elif cfg['ood_dataset'] == 'all':
            test_file_name = 'log_test_ood_all.txt'
        else:
            test_file_name = 'log_test_ood_common_newscore_sumversion.txt'
        ...
        with torch.no_grad():
            ...
            for images, labels in tqdm(test_loader_id):
                ...
                my_score = np.sum(smax_global[:, :len(cfg['classnames'])], axis=1)
                # print('my_score',my_score.shape)

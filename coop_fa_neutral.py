...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        self.text_features_classify_repeat = self.text_features_classify_repeat.to(image.device)
...
def main():
    ...
    model_name = 'fa'
    cache_dir = os.path.join('./mycaches_new', cfg['id_dataset'], model_file_name_dict[cfg['backbone']], str(cfg['shots'])+'shots',model_name+'_bs'+str(cfg['fine_tune_batch_size'])+'_ep'+str(cfg['fine_tune_train_epoch']),'wfirsttest-origin_neutral','lenx'+str(multiply_factor_name),'lr'+lrname,'seed'+str(cfg['seed'])  )  #   

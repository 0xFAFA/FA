...
def main():
    ...
    cfg['template'] = 'exactly a photo of a'  # 
    ...
    model_name = 'fa'
    cache_dir = os.path.join('./mycaches_new', cfg['id_dataset'], model_file_name_dict[cfg['backbone']], str(cfg['shots'])+'shots',model_name+'_bs'+str(cfg['fine_tune_batch_size'])+'_ep'+str(cfg['fine_tune_train_epoch']),'origin_neutral_and_likeforced_general',multiply_factor_name+'','lr'+lrname,'seed'+str(cfg['seed'])  )  #   
    ...
    if is_train == 1:
        ...
        if cfg['ood_dataset'] == 'challenging':
            ...
            test_file_name = 'log_test_ood_nearood0-2.txt'
        elif cfg['ood_dataset'] == 'common':
            test_file_name = 'log_test_ood_common0-2.txt'
        else:

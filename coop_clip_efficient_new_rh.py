...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        print(text_features[1,0:10])  
        print(text_features[2,0:10])
        print('-------')
        ...
        print(text_features_classify_final[0,0:10])
        print(text_features_classify_final[1,0:10])  
        print(text_features_classify_final[2,0:10])
        print('-------')
...
def main():
    ...
    if is_train == 1:
        sys.stdout = Logger( os.path.join(cache_dir,'log_train_t.txt') ,  stream=sys.stdout)
        print("\nRunning configs.")
        print(cfg, "\n")
        ...
        if cfg['ood_dataset'] == 'challenging':
            ...
            test_file_name = 'log_test_ood_common_t.txt'
        else:
